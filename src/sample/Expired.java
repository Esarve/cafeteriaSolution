...
public class Expired implements Initializable {
    ...
    private void loadDataBase(){
        try{
            preparedStatement = connection.prepareStatement("SELECT  item.item_code, item.item_name, item.item_type, item_details.item_price, item_details.item_quantity, item_details.exp_date FROM `item_details`, `item` WHERE item.item_code=item_details.item_code and sysdate() > exp_date ORDER BY item_code");
